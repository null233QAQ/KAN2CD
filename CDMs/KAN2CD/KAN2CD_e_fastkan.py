# use fastKAN by ZiyaoLi  https://github.com/ZiyaoLi/fast-kan
# 好像要更多epoch收敛  sometimes worse, not sure yet
...
# from ori_kan import *
from src.fastkan.fastkan import FastKAN as KAN
