...
import numpy as np
from .ori_KANLayer import *
from .ori_Symbolic_KANLayer import *
from .ori_LBFGS import *
import os
import glob
...
class KAN(nn.Module):
    ...
    def plot(self, folder="./figures", beta=3, mask=False, mode="supervised", scale=0.5, tick=False, sample=False, in_vars=None, out_vars=None, title=None,file_name = 'file'):
        '''
        plot KAN
